...
import CheckedSVG from "@/assets/icons/tos/checked.svg";
import UncheckedSVG from "@/assets/icons/tos/unchecked.svg";
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        <div className="flex flex-col px-2 gap-4 text-white text-xs font-SpaceGrotesk">
          <span className="">
